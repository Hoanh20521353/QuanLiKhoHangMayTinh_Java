...
public class Login extends javax.swing.JFrame {
    ...
    public Login() {
        ...
        panDefualt = Color.WHITE;
        panClick = Color.WHITE;
        panEnter = Color.WHITE;
    ...
    private void initComponents() {
        ...
        setTitle("Ứng dụng quản lí kho hàng máy ");
        setResizable(false);
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/main2.png"))); // NOI18N
        jLabel3.setPreferredSize(new java.awt.Dimension(420, 580));
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(-30, 0, 450, 580));
        ...
        JPaneLogin.setBackground(java.awt.Color.white);
        ...
        jLabel2.setBackground(new java.awt.Color(158, 158, 158));
        ...
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 420, 270, 40));

        jLabel1.setBackground(java.awt.Color.black);
        jLabel1.setFont(new java.awt.Font("Cantarell", 1, 20)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 0, 380, 100));
    ...
    public void checkLogin() {
        // Lấy giá trị người dùng nhập từ ô nhập loginUser (tên đăng nhập) và passwordUser (mật khẩu).
        ...
        if (usercheck.equals("") || passwordcheck.equals("")) {
            ...
            try {     
                // Truy vấn thông tin tài khoản từ cơ sở dữ liệu dựa vào tên đăng nhập (username).           
                ...
                if (acc == null) {
                    ...
                    // so sánh mật khẩu người dùng nhập (passwordcheck) với mật khẩu đã mã hóa lưu trong DB (acc.getPassword()).   
